...
export const TOOLS = [
    { id: 'ai-agent-hub', title: 'AI & Agent Hub', icon: 'psychology', category: 'AI & Agents', component: AiAgentHub, subTools: ['image-gen', 'chat', 'local', 'ingest', 'generate', 'results', 'setup'] },
    ...
    { id: 'dev-main', title: 'Dev Hub', icon: 'terminal', category: 'Developer Tools', component: DevTools, subTools: ['json-fmt', 'sql', 'diff', 'converter', 'security', 'password', 'rsa', 'regex', 'otp', 'kusto', 'base64', 'jwt', 'cron', 'url', 'word-rank', 'yaml', 'minifier', 'xml-json', 'xml-fmt', 'json-ts', 'color', 'qr-barcode'] },
    ...
    { id: 'fashion-main', title: 'Fashion Hub', icon: 'checkroom', category: 'Fashion', component: FashionTools, subTools: ['size-guide', 'fashion-guide', 'traditional-guide', 'shoes', 'accessories', 'clothes-guide', 'worldwide'] },
];
