...
export const TOOLS = [
    ...
    { id: 'lifestyle-main', title: 'Lifestyle Hub', icon: 'style', category: 'Lifestyle', component: LifestyleTools, subTools: ['size-guide', 'fashion-guide', 'traditional-guide', 'shoes', 'accessories'] },
];
